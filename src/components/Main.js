                                ...
                                <div className="row">
                                    ...
                                    <div className="col-xl-7 d-flex align-items-center">
                                        <div className="card-body">
                                            ...
                                            <div><small> Amount Donated: {microAlgosToString(post.total)} ALGO</small></div>
                                            <br />
                                            <p>{post.content}</p>
                                            <form onSubmit={tipSubmit} className="php-email-form">
                                                <div className="row gy-3">
                                                    <div className="col-md-12">
                                                        <input type="number" className="form-control" onChange={(e) => setTip(stringToMicroAlgos(e.target.value))} placeholder="Tip Amount (>0)" required />
                                                    </div>
                                                    <div className="col-md-12 text-center">
                                                        <button onClick={() => tip > 0 && tipFunction({ tip, post })} type="submit">TIP AUTHOR</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
